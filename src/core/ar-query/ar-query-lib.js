/**
 * ArQuery is a minimalistic library for handling API requests.
 ...
 * @param {Function} [options.onError] - Callback function to be called on error response.
 * @returns {Promise<{isLoading: boolean, error: string|null, data:ant|null}>} - An object containing the loading state, error and data from the response.
 */
